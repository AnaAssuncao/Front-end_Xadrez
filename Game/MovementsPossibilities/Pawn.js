function movementsPossibilitiesPawn(chessBoard=this.chessBoard,bottomPieceColor=this.statusGame.colorPieces.bottom,color=this.color, position=this.position,qtMovements=this.qtMovements){
